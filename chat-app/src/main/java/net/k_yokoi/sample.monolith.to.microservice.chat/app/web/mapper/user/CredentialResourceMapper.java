...
import net.k_yokoi.sample.monolith.to.microservice.chat.common.model.user.CredentialResource;
import net.k_yokoi.sample.monolith.to.microservice.chat.domain.model.entity.user.Credential;
