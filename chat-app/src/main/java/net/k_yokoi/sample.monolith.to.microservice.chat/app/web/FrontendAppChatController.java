package net.k_yokoi.sample.monolith.to.microservice.chat.app.web;

import net.k_yokoi.sample.monolith.to.microservice.chat.app.model.chat.ChatPortalInformation;
import net.k_yokoi.sample.monolith.to.microservice.chat.app.model.chat.GetMessagesResult;
import net.k_yokoi.sample.monolith.to.microservice.chat.app.web.mapper.chat.GetMessageResultMapper;
import net.k_yokoi.sample.monolith.to.microservice.chat.app.web.security.CustomUserDetails;
