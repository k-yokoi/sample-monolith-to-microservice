package net.k_yokoi.sample.monolith.to.microservice.chat.domain.service;
...
import net.k_yokoi.sample.monolith.to.microservice.chat.domain.repository.message.GroupRepository;
