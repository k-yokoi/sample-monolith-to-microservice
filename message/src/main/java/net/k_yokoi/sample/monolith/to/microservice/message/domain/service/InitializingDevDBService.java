package net.k_yokoi.sample.monolith.to.microservice.message.domain.service;
...
import net.k_yokoi.sample.monolith.to.microservice.message.domain.repository.message.GroupRepository;
