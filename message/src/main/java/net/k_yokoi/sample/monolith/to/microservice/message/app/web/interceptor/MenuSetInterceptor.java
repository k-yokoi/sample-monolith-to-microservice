package net.k_yokoi.sample.monolith.to.microservice.message.app.web.interceptor;
...
import net.k_yokoi.sample.monolith.to.microservice.message.app.model.Menu;
