...
import net.k_yokoi.sample.monolith.to.microservice.message.app.web.interceptor.MenuSetInterceptor;
...
@ComponentScan("net.k_yokoi.sample.monolith.to.microservice.message.app.web")
@Configuration
